...
exports.cRemove = exports.cRender = void 0;
var agar_1 = require("@ephox/agar");
var katamari_1 = require("@ephox/katamari");
var sugar_1 = require("@ephox/sugar");
var index_1 = require("src/main/ts/index");
// @ts-ignore
var vue_esm_bundler_js_1 = require("vue/dist/vue.esm-bundler.js"); // Use runtime compiler
...
var cRender = function (data, template) {
    ...
    return agar_1.Chain.async(function (_, next, die) {
        ...
        var vm = vue_esm_bundler_js_1.createApp({
            template: template,
            components: {
                Editor: index_1.default
            },
            data: function () {
                return __assign(__assign({}, data), { outputFormat: 'text', init: __assign(__assign({}, originalInit), { setup: function (editor) {
                            originalSetup(editor);
                            editor.on('SkinLoaded', function () {
                                setTimeout(function () {
                                    next({ editor: editor, vm: vm });
                                }, 0);
                            });
                        } }) });
            }
...
var cRemove = agar_1.Chain.op(function () {
